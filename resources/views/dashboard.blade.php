...
<head>
    ...
    <style>
        ...
        /* 🌙 القائمة الجانبية باللون الكحلي الغامق الفخم */
        .sidebar {
            width: 260px;
            ...
            /* 🛠️ الحل: تمكين السكرول الداخلي إذا كانت الشاشة قصيرة */
            overflow-y: auto; 
            max-height: 100vh;
            /* 🎨 تخصيص شكل شريط التمرير للـ Sidebar */
        }
        /* 🎨 تخصيص شكل شريط التمرير للـ Sidebar */
        ...
        .sidebar::-webkit-scrollbar-track {
            background: #0f172a; /* خلفية الشريط متناسقة مع السايدبار الغامق */
        }

        .sidebar::-webkit-scrollbar-thumb {
            background: #334155; /* لون المقبض رصاصي كحلي ناعم */
            border-radius: 10px; /* تدوير أطراف المقبض */
        }

        .sidebar::-webkit-scrollbar-thumb:hover {
            background: #2563eb; /* يتغير للون الأزرق عند التأشير عليه بالماوس */
        }
        ...
        /* 🎨 نصوص وأيقونات السايدبار الغامق */
        .sidebar .nav-link {
            color: #94a3b8 !important;
            font-weight: 600;
            padding: 0.5rem 1.25rem !important; /* تقليل الـ Padding العلوي والسفلي من 0.75rem إلى 0.5rem */
            border-radius: 10px;
        ...
        .sidebar .nav-link:hover {
            ...
            color: #38bdf8 !important; /* لون سماوي عند التمرير */
        }

        .sidebar .nav-link.active {
            background-color: #2563eb !important; /* أزرق أساسي للعنصر المفتوح */
        ...
        .sidebar .nav-link i {
            ...
            width: 24px;
            text-align: center;
            color: #38bdf8 !important; /* أيقونات سماوية مضيئة */
        }
        ...
        /* ☀️ الهيدر والكروت الفاتحة والمريحة للمحتوى */
        .navbar-custom {
...
<div class="wrapper">
    ...
    <aside class="sidebar p-3">
        ...
        <div class="text-light small fw-bold px-2 mb-2">الوصول السريع للأقسام</div>
